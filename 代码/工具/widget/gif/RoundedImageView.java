    ...
    private Drawable resolveResource() {
        ...
        if (mResource != 0) {
            try {
                ...
                LogUtil.getInstance().e(TAG, "Unable to find resource: " + mResource + " Exception:" + e.toString());
                // Don't try again.
                mResource = 0;
            }
        }
    ...
    private Drawable resolveBackgroundResource() {
        ...
        if (mBackgroundResource != 0) {
            try {
                ...
                LogUtil.getInstance().e(TAG, "Unable to find resource: " + mBackgroundResource + " Exception:" + e.toString());
                // Don't try again.
